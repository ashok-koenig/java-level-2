...
public class DemoController {
    ...
    public String adminURL() {
        return "This is protected URL content, authentication is required with admin role";
    }

    @GetMapping("/user")
    public String userURL() {
        return "This is protected URL content, authentication is required with user role";
    }
}
